    ...
    registerForm.addEventListener("submit", async function (event) {
      ...
      if (role === "student") {
        ...
        const subjects = document.querySelectorAll(
          '#subjects-group input[type="text"]'
        );
...
document.getElementById("courses").addEventListener("click", function () {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      document
        .querySelectorAll('#module-form input[type="checkbox"]:checked')
        .forEach((checkbox) => {
    ...
    facultySelect.addEventListener("change", function () {
      ...
      courseSelect.addEventListener("change", function () {
        ...
        yearSelect.addEventListener("change", function () {
          ...
          const selectedYear = selectedCourse.years_of_study.find(
            (year) => year.year === parseInt(selectedYearValue)
          );
